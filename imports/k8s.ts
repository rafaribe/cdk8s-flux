 ...
 *
 * @schema io.k8s.api.discovery.v1alpha1.EndpointSlice
 */
export class EndpointSlice extends ApiObject {
  /**
   * Defines a "io.k8s.api.discovery.v1alpha1.EndpointSlice" API object
   * @param scope the scope in which to define this object
   * @param name a scope-local name for the object
   * @param options configuration options
   */
 ...
 *
 * @schema io.k8s.api.discovery.v1alpha1.EndpointSliceList
 */
export class EndpointSliceList extends ApiObject {
  /**
   * Defines a "io.k8s.api.discovery.v1alpha1.EndpointSliceList" API object
   * @param scope the scope in which to define this object
   * @param name a scope-local name for the object
   * @param options configuration options
   */
...
export interface EndpointSliceOptions {
   ...
   *
   * @default IP
   * @schema io.k8s.api.discovery.v1alpha1.EndpointSlice#addressType
   */
   ...
   *
   * @schema io.k8s.api.discovery.v1alpha1.EndpointSlice#endpoints
   */
   ...
   *
   * @schema io.k8s.api.discovery.v1alpha1.EndpointSlice#metadata
   */
  readonly metadata?: ObjectMeta;
...
export interface EndpointSliceListOptions {
   ...
   *
   * @schema io.k8s.api.discovery.v1alpha1.EndpointSliceList#items
   */
 ...
 *
 * @schema io.k8s.api.discovery.v1alpha1.Endpoint
 */
export interface Endpoint {
  /**
   * addresses of this endpoint. The contents of this field are interpreted according to the corresponding EndpointSlice addressType field. This allows for cases like dual-stack (IPv4 and IPv6) networking. Consumers (e.g. kube-proxy) must handle different types of addresses in the context of their own capabilities. This must contain at least one address but no more than 100.
   *
   * @schema io.k8s.api.discovery.v1alpha1.Endpoint#addresses
   */
   ...
   *
   * @schema io.k8s.api.discovery.v1alpha1.Endpoint#conditions
   */
   ...
   *
   * @schema io.k8s.api.discovery.v1alpha1.Endpoint#hostname
   */
  readonly hostname?: string;
   ...
   *
   * @schema io.k8s.api.discovery.v1alpha1.Endpoint#targetRef
   */
 ...
 *
 * @schema io.k8s.api.discovery.v1alpha1.EndpointConditions
 */
